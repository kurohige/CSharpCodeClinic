...
/*
 * Project attempt by Jose Hidalgo, Code Clinic C# from Linkedin ~~ Completed on 11/17/2021
 * Things to note:
 * - TryParse and Error Handling was used on this project, this allowed me to test any error that may occur when reading a file information and parsing it into a text
 * - Was able to make use of LINQ, "Language Integrated Query", it is my first time look and trying this out, I'm looking forward to complete the LINQ course from Linkedin as well. 
 * - Usage of MATH.NET for Fit.Line()
 * - Usage of LiveCharts for Drawing Graphs. 
 * - I also made use of the NFluent class to make certain methods more readable, I'm also looking to try that out more.  
 * 
 */
...
namespace Tests_WeatherData
{
    ...
    {
        private static string filename = @"D:\CSharp Proj\Code Clinic for CSharp\Exercise Files\Ch01\pond_data\Environmental_Data_Deep_Moor_2012.txt";
...
2012_01_01 00:21:00	33.80	30.60	27.30	76.60	280.80	17.00	14.00";
        ...
        public void Test_020_TryParseLine()
        {
            ...
            var tryParseOutcome = WeatherObservation.TryParse(text, out WeatherObservation wo); // TODO: Implement the TryParse method
